...
export default function ScrollableTabsButtonAuto() {
  ...
  const handleSubmit = (pID, bID) => {
    axios
      .post(
        "http://localhost:5000/api/v1/order/complete-stay",
        {
          placeID: pID,
          review: review,
          rating: ratingValue,
  ...
  useEffect(() => {
    axios
      .post(
        "http://localhost:5000/api/v1/place/get-my-requests",
        {},
        {
          withCredentials: true,
        }
    ...
    axios
      .post(
        "http://localhost:5000/api/v1/place/get-my-places",
        {},
        {
          withCredentials: true,
        }
  ...
  const handleShowDesc = (id) => {
    axios
      .post(
        "http://localhost:5000/api/v1/place/get-description",
        {
          placeID: id,
        },
        {
  ...
  const handleCancel = (bookingID, rentee) => {
    axios
      .post(
        "http://localhost:5000/api/v1/place/cancel-place",
        {
          bookingID: bookingID,
          rentee,
        },
  ...
  const handleApprove = (bookingID, placeID, checkIn, checkOut, rentee) => {
    axios
      .post(
        "http://localhost:5000/api/v1/place/book-place",
        {
          bookingID: bookingID,
          placeID: placeID,
          checkIn: checkIn,
                            ...
                            <td>
                              {place.status === "Pending" && (
                                <Button
                                  ...
                                  color="primary"
                                  onClick={() =>
                                    handleCancel(place._id, place.rentee)
                                  }
                                >
                                  Cancel
                                </Button>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            <span>Address: {desc.address}</span>
            <br />
            <span>City: {desc.city}</span>
            <br />
            <span>Country: {desc.country}</span>
            <br />
          </DialogContentText>
        </DialogContent>
      </Dialog>
